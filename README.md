...
# <a name="_toc148118213"></a>**Overview**
...
# <a name="_toc148118215"></a>**Features**
...
## <a name="_toc148118217"></a>**Menu Options**
1. **Add Resources:** Add resources to the project, along with their skills and proficiency.
1. **Add Task:** Add tasks to the project, specifying task duration, dependencies, and required skills.
1. **Set Task Duration:** Set the duration of each task in the project.
1. **Set nth Task Duration:** Set the duration of a specific task.
1. **Print Task Dependency List:** Display the list of tasks and their dependencies.
1. **Calculate Basic Schedule:** Calculate the project schedule with the CPM method.
1. **Print Critical Path:** Display the critical path of the project.
1. **Completion Time with Resources:** Calculate the project completion time considering resources.
1. **Completion Time with Resource Proficiency:** Calculate the project completion time considering resource proficiency.
1. **Exit:** Exit the program.
# <a name="_toc148118218"></a>**Classes**
## <a name="_toc148118219"></a>**Skill Class**
The Skill class represents a skill with an ID and proficiency level.
### <a name="_toc148118220"></a>**Properties**
- id (int): An identifier for the skill.
- proficiency (float): The proficiency level of the skill.
### <a name="_toc148118221"></a>**Constructors**
...
### <a name="_toc148118222"></a>**Methods**
...
## <a name="_toc148118223"></a>**SkillNode Class**
The SkillNode class is a node for creating a linked list of skills.
### <a name="_toc148118224"></a>**Properties**
...
### <a name="_toc148118225"></a>**Methods**
...
## <a name="_toc148118226"></a>**Resource Class**
...
### <a name="_toc148118227"></a>**Properties**
...
### <a name="_toc148118228"></a>**Constructors**
...
### <a name="_toc148118229"></a>**Methods**
...
## <a name="_toc148118230"></a>**Task Class**
...
### <a name="_toc148118231"></a>**Properties**
...
### <a name="_toc148118232"></a>**Constructors**
...
### <a name="_toc148118233"></a>**Getters**
...
### <a name="_toc148118234"></a>**Setters**
...
## <a name="_toc148118235"></a>**TaskNode Class**
The TaskNode class represents a node in a linked list of tasks.
### <a name="_toc148118236"></a>**Properties**
...
### <a name="_toc148118237"></a>**Constructors**
...
### <a name="_toc148118238"></a>**Getters**
...
## <a name="_toc148118239"></a>**TaskList Class**
The TaskList class represents a linked list of tasks.
### <a name="_toc148118240"></a>**Properties**
...
### <a name="_toc148118243"></a>**Setters**
...
### <a name="_toc148118244"></a>**Methods**
...
## <a name="_toc148118245"></a>**Project**
...
### <a name="_toc148118246"></a>**Properties**
...
### <a name="_toc148118249"></a>**Setters**
...
### <a name="_toc148118250"></a>**Methods**
...
- set\_nth\_TaskDuration(): This function allows the user to set the duration of the nth task in the system. It asks the user for the task number (n) and then updates the duration of that specific task.
...
# <a name="_toc148118251"></a>**Summary**
...
# <a name="_toc148118252"></a>**References**
[Asana - Critical Path Method](https://asana.com/resources/critical-path-method)

[GeeksforGeeks - Software Engineering Critical Path Method](https://www.geeksforgeeks.org/software-engineering-critical-path-method/)
